...
def read_obo_without_gci_is_a(obo_path, ignore_obolete=True):
    ...
    with tempfile.NamedTemporaryFile(
        ...
        tmp_path = tmp.name
    return obonet.read_obo(tmp_path, ignore_obsolete=ignore_obolete)
...
class OntologyGraph: 
    ...
    @classmethod
    def from_obo(cls, obo_path, relationship='is_a', ignore_obsolete=True):
        return cls(read_obo_without_gci_is_a(obo_path, ignore_obolete=ignore_obsolete), relationship)
...
class OntologyGraphNew:
    ...
    def __init__(self,
        ...
        self._rel_subgraph = OntologyGraphNew.build_relationship_subgraph(self.graph, self.relationship)
        ...
        self._alt_id_to_idx = OntologyGraphNew._build_alt_id_map(self._rel_subgraph)
    ...
    def induced_subgraph(self, indices, as_ontology_graph=False):
        ...
        if as_ontology_graph:
            return OntologyGraphNew(sub, self.relationship)
        return sub
