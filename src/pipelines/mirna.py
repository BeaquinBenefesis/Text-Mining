...
def run_mirna_pipeline(output_name: str, sentence_path = None):
    ...
    process_mirna_hits(
        ...
        families_path=config.families_path,
        precursors_path=config.precursor_path,
        mature_path=config.mature_path,
        parent_to_child_path=config.parent_to_child_path,
        mirna_taxons_path=config.mirna_taxons_path,
        mirna_2_prefix_path=config.mirna_to_prefix_path,
        family_normalizer_path=config.family_norm_path,
        precursor_normalizer_path=config.precursor_norm_path,
